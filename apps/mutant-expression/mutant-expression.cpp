...
void usage()
{
    fprintf(stderr, "usage: mutant-expression index inputFile {-h} {-vcf} {-germline} {-consolodatedInput inputFilename}\n");
    ...
    fprintf(stderr, "conolodated input is a file generated by GenerateConsolodatedExtractedReads.  You can have as many of these as you'd like, and they'll\n");
...
int main(int argc, char* argv[])
{
    ...
    for (int i = 3; i < argc; i++) {
        if (!strcmp(argv[i], "-h")) {
            ...
            if (germlineStyleInput) {
                fprintf(stderr, "Can't have both -vcf and -germline\n");
                usage();
            }
            vcfStyleInput = true;
        }
    ...
    while (fgets(inputBuffer, inputLineSize - 1, inputFile)) {
        ...
        for (int pass = 0; pass < ((vcfStyleInput || germlineStyleInput) ? 2 : 1); pass++) {
            if (vcfStyleInput) {
                if (0 == pass) {
                    RNAFileName = 10;
                } else {
