...
public:
	...
	//
	void lookupSeed(Seed seed, GenomeLocation minLocation, GenomeLocation maxLocation, _int64 *nHits, const GenomeLocation **hits,
		_int64 *nRCHits, const GenomeLocation **rcHits, GenomeLocation *singleHit, GenomeLocation *singleRCHit);
		
	void lookupSeed32(Seed seed, GenomeLocation minLocation, GenomeLocation maxLocation,
		_int64 *nHits, const unsigned **hits, _int64 *nRCHits, const unsigned **rcHits);
