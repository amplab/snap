...
class TenXGroupAligner : public PairedEndAligner
{
public:
    TenXGroupAligner(
        GenomeIndex  *index_,
    ...
    void *operator new(size_t size, BigAllocator *allocator) {_ASSERT(size == sizeof(TenXGroupAligner)); return allocator->allocate(size);}
...
private:
    ...
    TenXGroupAligner() : alignmentAdjuster(NULL) {}  // This is for the counting allocator, it doesn't build a useful object
