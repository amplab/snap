...
AlignerOptions::usageMessage()
{
    WriteErrorMessage(
        ...
        "       is counted.\n"
        "  -pc  Preserve the soft clipping for reads coming from SAM or BAM files (this is on by default for 10x alignments and may be turned off by --pc).\n"
